...
pub async fn location1(location: String, address_map: HashMap<String, LocationInfo>) {
  println!("Running {}", location);

  let swirl = Arc::new(Swirl::new(location.clone(), address_map, "./workdir/location1".into()));
